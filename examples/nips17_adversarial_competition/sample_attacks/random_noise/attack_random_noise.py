...
tf.flags.DEFINE_integer(
    'image_width', 160, 'Width of each input images.')

tf.flags.DEFINE_integer(
    'image_height', 160, 'Height of each input images.')
...
def save_images(images, filenames, output_dir):
  ...
  for i, filename in enumerate(filenames):
    ...
    with tf.gfile.Open(os.path.join(output_dir, folder_name, filename), 'w') as f:
